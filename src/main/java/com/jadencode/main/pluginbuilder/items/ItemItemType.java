 ...
 */
public class ItemItemType extends Item {
    ...
    public ItemItemType(String name, String owner, String stats, String script, float weight, String primary, List<String> parts) {
        super(name, owner);
