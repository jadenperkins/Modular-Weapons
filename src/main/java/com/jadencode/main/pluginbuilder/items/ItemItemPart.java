 ...
 */
public class ItemItemPart extends Item {
    ...
    public ItemItemPart(String name, String owner, String nameMod, String partInfo, float weight, String partType, String statSet, String icon, List<String> materialTypes) {
        super(name, owner);
