 ...
 */
public class ItemPartEditor extends ContentEditor<ItemItemPart> {
    ...
    public ItemPartEditor(Module module, PluginBuilderPanel parent) {
        super(module, parent);
    ...
    @Override
    public void onOpened(Module<ItemItemPart> parent, PluginBuilderPanel panel) {
    ...
    @Override
    public void populate(ItemItemPart item) {
    ...
    @Override
    public ItemItemPart createItem(String name, String owner) {
        ...
        return new ItemItemPart(name, owner, nameMod, partInfo, weight, partType, statSet, iconName, materialTypes);
    }
    ...
    @Override
    public ItemItemPart getDefault() {
        return new ItemItemPart("", "", "", "", 0F, "", "", "", new ArrayList<>());
    }

    @Override
    public ItemItemPart consume(String name, JsonObject json, String owner) {
        ...
        return new ItemItemPart(name, owner, nameMod, partInfo, weight, partType, statSet, iconName, materials);
    }
}