 ...
 */
public class ItemTypeEditor extends ContentEditor<ItemItemType> {
    ...
    public ItemTypeEditor(Module module, PluginBuilderPanel parent) {
        super(module, parent);
    ...
    @Override
    public void populate(ItemItemType item) {
    ...
    @Override
    public void onOpened(Module<ItemItemType> parent, PluginBuilderPanel panel) {
    ...
    @Override
    public ItemItemType createItem(String name, String owner) {
        ...
        return new ItemItemType(name, owner, stat, script, weight, primary, parts);
    }
    ...
    @Override
    public ItemItemType getDefault() {
        return new ItemItemType("", "", "", "", 1F, "", new ArrayList<>());
    }

    @Override
    public ItemItemType consume(String name, JsonObject json, String owner) {
        ...
        return new ItemItemType(name, owner, statSet, script, weight, primary, parts);
    }
}