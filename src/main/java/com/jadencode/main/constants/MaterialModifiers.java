...
public class MaterialModifiers {
    ...
    public static final MaterialModifier dark = new MaterialModifier("Dark", Colors.METAL_MOD_DARK, 1F, 1.25F, 1.2F, MaterialTypes.MATERIAL_METAL, MaterialTypes.MATERIAL_WOOD);//metal, wood
