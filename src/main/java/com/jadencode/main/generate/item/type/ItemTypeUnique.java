...
public class ItemTypeUnique extends ItemType<ItemUnique> {
    ...
    public ItemTypeUnique(String name, float w, StatSet stats, String info, QualityLevel level, ScriptItem s) {
    ...
    public ItemUnique create(Random r, int level) {
        return new ItemUnique(this, level);
    }
    @Override
    public ItemUnique scaled(ItemUnique original, int i) {
        return new ItemUnique(this, i);
    }
    @Override
