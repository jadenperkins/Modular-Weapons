...
import com.main.plugins.loaders.ContentManager;
...
public final class ContentLoader {
    ...
    private void loadStaticContent() {
        Set<Class<? extends ContentManager>> managerClasses = new Reflections("com.main.plugins.loaders").getSubTypesOf(ContentManager.class);
